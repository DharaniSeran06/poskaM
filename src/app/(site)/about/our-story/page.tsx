    ...
    <main>
      ...
      >
        ...
        <p className="text-lg text-gray font-normal max-w-md w-full mx-auto mt-7 sm:px-0 px-4">
          Building trust, quality and craftsmanship since 2003
        </p>
        <div className="mt-8">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mt-8 text-center" data-aos="fade-up" data-aos-delay="400">
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Discover the journey of POSKA MANOLITO AG, from our humble beginnings in 2003 to becoming a trusted leader in construction, plastering, facades, and painting services across Switzerland.
              </p>
            </div>
          </div>
        </div>
