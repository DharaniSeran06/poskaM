...
const Header: React.FC = () => {
  ...
  const WHATSAPP_LINK = "https://wa.me/41523472540";
      ...
      <div className="bg-[#016aac] text-white py-2 hidden lg:block">
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
          <div className="flex items-center justify-end space-x-6 text-sm">
            ...
            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 hover:opacity-80 transition-opacity">
        ...
        <div className="p-4 bg-[#016aac] text-white">
          <div className="space-y-3">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="flex items-center gap-3 p-3 bg-[#25D366]/20 rounded-xl hover:bg-[#25D366]/30 transition-colors active:scale-[0.98]"
            >
              ...
              <div>
                <span className="text-xs opacity-80 block">Message Us</span>
